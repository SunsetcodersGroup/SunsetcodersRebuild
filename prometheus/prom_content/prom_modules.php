        ...
        while (false !== ($entry = readdir($handle))) {
            if ($entry != "." && $entry != ".." && $entry != "auth.css") {
                ...
                if ($stmt = $dbConnection->prepare("SELECT settingsFilename FROM settings WHERE settingsFilename=? ")) {
                    ...
                    if ($settingsFilename) {
                        echo '<br><br><a href="?id=Modules&&moduleID=DeactivateModule&&moduleName=' . $moduleName . '">Deactivate</a>';
                    } else {
                        echo '<br><br><a href="?id=Modules&&moduleID=ActivateModule&&moduleName=' . $moduleName . '">Activate</a>';
                    }
                }
